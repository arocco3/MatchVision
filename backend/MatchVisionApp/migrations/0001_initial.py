# Generated by Django 5.2.5 on 2025-08-24 14:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('TECHNICAL_TIMEOUT', 'TimeOut tecnico'), ('CHANGE', 'Cambio'), ('DOUBLE_CHANGE', 'Doppio cambio'), ('MEDICAL_CHANGE', 'Cambio medico'), ('YELLOW_CARD', 'Cartellino giallo'), ('RED_CARD', 'Cartellino rosso'), ('SCORED_POINT', 'Punto generico eseguito'), ('CONCEDED_POINT', 'Punto generico subito'), ('DOUBLE_FAULT', 'Palla contesa')], max_length=30, verbose_name='Tipo evento')),
            ],
            options={
                'verbose_name': 'Evento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, max_length=20, null=True, verbose_name='Ruolo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fundamental', models.CharField(choices=[('SERVE', 'Servizio'), ('SERVE_RECEIVE', 'Ricezione'), ('SET', 'Alzata'), ('ATTACK', 'Attacco'), ('BLOCK', 'Muro'), ('DEFENSE', 'Difesa')], max_length=15, verbose_name='Fondamentale')),
                ('outcome', models.CharField(choices=[('POSITIVA', '++'), ('BUONA', '+'), ('NEUTRA', '/'), ('NEGATIVA', '-'), ('ERRORE', '--')], max_length=8, verbose_name='Esito')),
