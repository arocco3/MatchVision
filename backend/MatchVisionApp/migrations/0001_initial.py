    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playersList', models.ManyToManyField(blank=True, related_name='teams', to='MatchVisionApp.player')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teams', to='MatchVisionApp.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='match',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='matches', to='MatchVisionApp.team'),
        ),
        migrations.CreateModel(
            name='Touch',
            fields=[
        ...
        migrations.AddField(
            model_name='player',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players', to='MatchVisionApp.user'),
        ),
        migrations.AddField(
            model_name='match',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='matches', to='MatchVisionApp.user'),
        ),
    ]
